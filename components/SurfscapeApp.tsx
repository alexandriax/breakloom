        ...
        >
          ...
          >
            ...
            <div className={`mobile-balance-stack ${motionBalanceActive ? "is-motion" : ""}`}>
              ...
              {(stats.phase === "riding" || stats.phase === "paddling") && !ridingOut ? (
                <div
            ...
            {stats.phase === "riding" && stats.waveEngaged && !ridingOut && (
