    ...
    if (active) {
      if (currentPhase === "shore") {
        ...
        const bodyVertical = advanceSeparatedSurferVerticalDynamics(
          ...
          {
            deltaSeconds: delta,
            downwardWaterVelocity: -residualWash
              * (1.45 + wipeoutPower.current * 1.35),
          },
        );
        wipeoutBodyVertical.current.surfaceOffset =
