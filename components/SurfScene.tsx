...
const OCEAN_FRAGMENT = /* glsl */ `
  ...
  void main() {
    ...
    float lipElevation = smoothstep(.48, 1.18, vCrest);
    float lipSteepness = smoothstep(.035, .32, faceSteepness);
