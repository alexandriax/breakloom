  ...
  useFrame(({ clock, gl }, delta) => {
    ...
    if (active) {
      if (currentPhase === "shore") {
        ...
        const coastalZ = position.current.z - tideShift;
        const breakCoastalZ = waveBreakingCoordinateAt(
          position.current.x,
          position.current.z,
          t,
          settings,
